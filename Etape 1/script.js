...
function firstQuote(){
    let quote = firstWords[getRandomInt(0,7)] + secondWords[getRandomInt(0,7)] + thirdWords[getRandomInt(0,7)] + fourthWords[getRandomInt(0,7)] + fifthWords[getRandomInt(0,7)];
    console.log(quote);
}
firstQuote();